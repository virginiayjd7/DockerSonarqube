...
# Docker desktop  http://localhost:9999/
...
# Docker desktop dotnet sonarscanner begin /d:sonar.login=admin /d:sonar.host.url="http://192.168.99.100:9000".password=admin /k:”aplicacionNetCore”
...
# Docker desktop dotnet sonarscanner end /d:sonar.login=admin /d:sonar.password=admin 
# Docker toolbox Docker toolbox -> dotnet SonarScanner end /d:sonar.login="fe2c04f332a90a0e90f02c220a66c58f8d1f13ce"
